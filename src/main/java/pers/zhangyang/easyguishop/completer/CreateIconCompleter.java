...
public class CreateIconCompleter extends CompleterBase {
    public CreateIconCompleter(@NotNull CommandSender sender, @NotNull String[] args) {
        super(sender, args);
    }
    ...
    public @NotNull List<String> complete() {
        if (args.length == 2) {
            List<String> stringList = CompleterYaml.INSTANCE.getStringList("completer.easyGuiShopCreateIcon");
            if (stringList != null) {
