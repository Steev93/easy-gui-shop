...
public class SetIconStockCompleter extends CompleterBase {
    public SetIconStockCompleter(@NotNull CommandSender sender, @NotNull String[] args) {
        super(sender, args);
    }
    ...
    public @NotNull List<String> complete() {
        if (args.length == 2) {
            List<String> stringList = CompleterYaml.INSTANCE.getStringList("completer.easyGuiShopSetIconStock");
            if (stringList != null) {
