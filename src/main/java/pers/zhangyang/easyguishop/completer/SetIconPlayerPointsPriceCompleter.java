...
public class SetIconPlayerPointsPriceCompleter extends CompleterBase {
    public SetIconPlayerPointsPriceCompleter(@NotNull CommandSender sender, @NotNull String[] args) {
        super(sender, args);
    }
    ...
    public @NotNull List<String> complete() {
        if (args.length == 2) {
            List<String> stringList = CompleterYaml.INSTANCE.getStringList("completer.easyGuiShopSetIconPlayerPointsPrice");
            if (stringList != null) {
